...
void
Roster::add(string studentID, string students_firstName, string students_lastName, string students_email, int students_age, int daysInCourse, int daysInCourse1, int daysInCourse2, DegreeProgram stringDegreeProgram) 
{
  int students_courseDay[3];
    ...
    for (int i = 0; i < 3; ++i)
    {
        ...
        {
            classRosterArray[++lastInput] = new Student(studentID, students_firstName, students_lastName, students_email, students_age, daysInCourse, daysInCourse1, daysInCourse2, stringDegreeProgram);
        }
...
cout << "Student ID number: " << studentID <<
...
cout << "Student ID number: " << studentID << " does not exist." <<
	    endl;
...
cout << "The average of student ID number: " << studentID <<
	    " is: " << getAvg << endl;
...
if ((stu_temp_email.find ("@") == string::npos
	    || stu_temp_email.find (".") == string::npos)
	   || (stu_temp_email.find (" ") != string::npos))
...
void
Roster::printByDegreeProgram (DegreeProgram stringDegreeProgram) 
{
...
/*void
Roster::add(string studentID, string students_firstName, string students_lastName, string students_email, int students_age, int daysIn[], DegreeProgram stringDegreeProgram) 
{
  int students_courseDay[3];
...
classRosterArray[lastInput] =
    new Student (studentID, students_firstName, students_lastName,
		 students_email, students_age, daysIn[], stringDegreeProgram);
